                        ...
                        <div class="col-sm-6">
                            <div class="social-icons pull-right">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="https://ranaartist.000webhostapp.com/"><i class="fa fa-linkedin"></i></a></li>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="logo pull-left">
                                <a href="index.php"><img style="width: 170px;height:100px;" src="images/home/ranaartlogo.png" alt="" /></a>
                            </div>
                        ...
                        <div class="col-sm-8">
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">
                                    <li><a href="#"><i class="fa fa-user"></i> <?php if (isset($_SESSION['adminname'])) {
